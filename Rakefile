...
require "multi_handler"
require "multi_handler/database_tasks"

namespace :multi_handler do
  namespace :db do
    task :rails_env do
    ...
    task migrate: :load_config do
      ...
      MultiHandler.establish_connections(env)
    ...
    task reset: ["multi_handler:db:drop", "multi_handler:db:create", "multi_handler:db:migrate"]
  end
end
