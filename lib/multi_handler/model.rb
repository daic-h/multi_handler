require "multi_handler/connection_manager"
...
module MultiHandler
  module Model
    ...
    included do
      ...
      self.connection_manager = ConnectionManager.new(default_connection_handler)
    ...
    module ClassMethods
      ...
      def default_db(conn_name)
        handler = on_db(conn_name).connection_handler
...
ActiveRecord::Base.send(:include, MultiHandler::Model)
