...
ActiveRecord::Migration.send(:include, MultiHandler::Migration)
ActiveRecord::MigrationProxy.send(:include, MultiHandler::MigrationProxy)
ActiveRecord::Migrator.send(:include, MultiHandler::Migrator)
